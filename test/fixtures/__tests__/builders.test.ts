...
describe('buildChannel', () => {
  it('returns a complete object with all required fields', () => {
    ...
    expect(channel.identifier).toBeDefined();
  ...
  it('correctly overrides the identifier field', () => {
    const channel = buildChannel({ identifier: 'custom' });
    expect(channel.identifier).toBe('custom');
...
describe('buildChannelCreate', () => {
  it('returns a valid create payload without EntityBase fields', () => {
    ...
    // identifier is auto-generated by the API, not in ChannelCreate
    expect(data).not.toHaveProperty('identifier');
    expect(data.url).toBeDefined();
    // channelType is read-only on response types, not on ChannelCreate
    expect(data).not.toHaveProperty('channelType');
