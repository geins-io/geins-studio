#!/usr/bin/env bash
# =============================================================================
# GEINS STUDIO - Bicep Template Validation Script
# =============================================================================
...
show_help() {
    ...
    echo ""
    echo "Validates the Bicep templates for the Geins Studio infrastructure."
    echo ""
    echo "Options:"
...
validate_what_if() {
    local environment="$1"
    local resource_group="rg-studio-${environment}"
    ...
    az deployment group what-if \
        ...
        --parameters containerImage="ghcr.io/geins-io/geins-studio:validate"
...
main() {
    ...
    echo ""
    echo "============================================================================="
    echo "  Geins Studio - Bicep Template Validation"
    echo "============================================================================="
    echo ""
