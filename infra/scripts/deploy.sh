#!/usr/bin/env bash
# =============================================================================
# GEINS STUDIO - Manual Deployment Script
# =============================================================================
# This script deploys the Geins Studio infrastructure and application to Azure.
...
show_help() {
    ...
    echo ""
    echo "Deploys the Geins Studio infrastructure and application to Azure."
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --env dev --image ghcr.io/geins-io/geins-studio:dev"
    echo "  $0 --env staging --image ghcr.io/geins-io/geins-studio:main --what-if"
    echo "  $0 --env prod --image ghcr.io/geins-io/geins-studio:v1.0.0"
    echo ""
}
...
main() {
    ...
    echo ""
    echo "============================================================================="
    echo "  Geins Studio - Manual Deployment"
    echo "============================================================================="
    echo ""
    ...
    # Run deployment
    deploy "$environment" "$container_image" "$ghcr_username" "$ghcr_token" "$what_if"
}
