#!/usr/bin/env bash
# =============================================================================
# GEINS STUDIO - Azure Infrastructure Setup Script
# =============================================================================
# This script sets up the Azure infrastructure for Geins Studio including:
...
# -----------------------------------------------------------------------------
APP_NAME="studio"
SP_DISPLAY_NAME="studio-github-actions"
LOCATION="${AZURE_LOCATION:-westeurope}"
GITHUB_REPO="${GITHUB_REPOSITORY:-geins-io/geins-studio}"
...
print_github_secrets() {
    ...
    echo "├─────────────────────────┼───────────────────────────────────────────────┤"
    printf "│ %-23s │ %-45s │\n" "BASE_URL" "https://studio-{env}-app.azurewebsites.net"
    printf "│ %-23s │ %-45s │\n" "GEINS_DEBUG" "false"
    printf "│ %-23s │ %-45s │\n" "LOG_LEVEL" "info"
    echo "└─────────────────────────┴───────────────────────────────────────────────┘"
    echo ""
...
show_help() {
    ...
    echo ""
    echo "Sets up Azure infrastructure for Geins Studio."
    echo ""
    echo "Options:"
    ...
    echo "  GITHUB_REPOSITORY       GitHub repository (default: geins-io/geins-studio)"
    echo ""
    echo "Examples:"
...
main() {
    ...
    echo ""
    echo "============================================================================="
    echo "  Geins Studio - Azure Infrastructure Setup"
    echo "============================================================================="
    echo ""
