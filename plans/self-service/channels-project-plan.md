...
- [ ] **2.2 Languages card — Default language section**
...
- [ ] **2.3 Languages card — Additional languages section**
...
- [ ] **3.1 Markets card — Default market section**
...
- [ ] **3.2 Markets card — Additional markets table**
...
- [ ] **3.3 Add market dialog**
  - `Dialog` containing `FormInputTagsSearch` (same component as "Add language" — see task 2.3). Market data needs mapping to `EntityBaseWithName` shape (use country name as display). Pass `disableTeleport` for Dialog context.
...
## Milestone 4: Storefront Settings Tab (Highest Priority Feature)
...
- [ ] **4.1 Define the JSON schema specification**
...
- [ ] **4.2 Create default Geins storefront schema**
...
- [ ] **4.3 Schema renderer component** (`app/components/channel/StorefrontSchemaRenderer.vue`)
...
- [ ] **4.4 Schema tab container** (`app/components/channel/ChannelStorefrontSettings.vue`)
...
## Milestone 7: Product Search Tab
...
- [ ] **7.2 Custom search field configuration**
...
## Milestone 8: Polish & Integration
...
| Search endpoint unknown             | Blocks Milestone 7                   | Same approach — UI first                                      |
...
├── Milestone 2: General Tab
├── Milestone 3: Markets Tab
├── Milestone 4: Storefront Settings (highest priority to start)
├── Milestone 5: Payments Tab
├── Milestone 6: Mails Tab
├── Milestone 7: Product Search Tab
└── Milestone 8: Polish & Integration
...
> **Recommended build order**: M1 (foundation) → M4 (storefront, highest priority) → M2 (general) → M3 (markets) → M5 (payments) → M6 (mails) → M8 (polish) → M7 (search, lowest priority)
