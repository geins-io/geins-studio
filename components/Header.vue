...
import { Search, MoonStar, Sun, User, LogOut, CircleHelp, CreditCard } from 'lucide-vue-next'
...
<template>
    <header class="flex items-center justify-start bg-background text-background-foreground">
        <div class="w-56 pl-4">
            <LogoDark v-if="colorMode.value === 'light'" :font-controlled="false" class="w-20" />
            <LogoLight v-else :font-controlled="false" class="w-20" />
        </div>
        <div class="relative w-full max-w-sm items-center">
            <Input id="search" type="text" placeholder="Search..." class="pl-10 bg-popover" />
        ...
        <div class="mr-4">
            <DropdownMenu>
                <DropdownMenuTrigger class="h-10 w-10">
                    <Avatar class="h-10 w-10 border border-stone-200">
