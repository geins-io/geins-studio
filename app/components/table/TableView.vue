...
<template>
  ...
  <div
    :class="
      cn(
        'relative -mb-56 mt-40 overflow-hidden rounded-lg border pb-14 shadow-sm transition-[margin-top]',
        `${tableMaximized ? 'absolute -bottom-40 left-8 right-8 top-[4rem] mb-0 mt-0' : '-translate-y-40'}`,
      )
    "
  >
    <Table>
