...
export const alertVariants = cva(
  'relative w-full rounded-lg border bg-transparent px-4 py-3 text-sm text-foreground shadow-xs [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        default: '',
