...
<template>
  <div
    ...
    :class="
      selected
        ? 'border-orange-500 ring-[6px] ring-orange-500/20'
        : 'border-orange-500/50'
    "
  >
    <!-- Input handle -->
    <WorkflowHandleInput
      handle-class="!border-background !h-[15px] !w-[15px] !border-2 !bg-orange-500"
    />
    ...
    <div
      v-if="summary"
      class="text-muted-foreground bg-muted/50 mt-2 flex items-center gap-1.5 truncate rounded px-2 py-1 text-xs"
    >
      <component
        :is="SummaryIcon"
        v-if="SummaryIcon"
