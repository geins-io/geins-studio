...
<template>
  <div
    ...
    :class="selected ? 'border-teal-500 ring-[6px] ring-teal-500/20' : 'border-teal-500/50'"
  >
    <!-- Input handle -->
    <WorkflowHandleInput handle-class="!border-background !h-[15px] !w-[15px] !border-2 !bg-teal-500" />
