...
const IconComponent = computed(
  () => resolveIcon(props.data.icon) || resolveIcon('Workflow'),
);
...
<template>
  <div
    ...
    :class="
      selected
        ? 'border-teal-500 ring-[6px] ring-teal-500/20'
        : 'border-teal-500/50'
    "
  >
    <!-- Input handle -->
    <WorkflowHandleInput
      handle-class="!border-background !h-[15px] !w-[15px] !border-2 !bg-teal-500"
    />

    <div class="flex items-center gap-3">
      <div
        class="flex h-10 w-10 items-center justify-center rounded-lg bg-teal-500/10 text-teal-500"
      >
