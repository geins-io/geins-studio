export default defineI18nLocale(async () => {
  return {
    ...
    entity_details: '@.capitalize:{entityName} details',
    ...
    form: {
      ...
      optional: 'optional',
      cannot_be_changed: 'Cannot be changed upon creation',
    },
    address: {
      title: 'Address',
    ...
    wholesale: {
      ...
      pricelists_description: 'Pricelists connected to this account.',
      buyers: 'Buyers',
      buyers_description: 'Buyers connected to this account',
      ...
      vat_validation_summary_label: 'VEIS Information',
      pricelist_channel: 'Channel',
      pricelist_currency: 'Currency',
      pricelist_forced: 'Override prices',
      pricelist_products_pricing: 'Products & Pricing',
      ...
      pricelist_full_range_adjustments_description:
        'Adjust prices for all products in the pricelist.',
