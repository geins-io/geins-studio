...
<template>
  ...
  <div class="-mb-12 flex min-h-0 flex-1 flex-col @2xl:-mb-14">
    ...
    <!-- Scrolling step content between the pinned stepper and footer. -->
    <div class="min-h-0 flex-1 overflow-y-auto">
      <Card>
        <CardContent class="p-6">
          ...
          <template v-if="currentStep === 1">
            <div class="space-y-1">
              <h2 class="text-lg font-semibold">
                {{ $t('asset_library.wizard_step_files') }}
              </h2>
              <p class="text-muted-foreground text-sm">
                {{ $t('asset_library.wizard_files_hint') }}
              </p>
            </div>
          ...
          <!-- Step 2 — manage (STU-319 / STU-320) -->
          <template v-else-if="currentStep === 2">
            <div class="text-muted-foreground py-12 text-center text-sm">
              {{ $t('asset_library.wizard_step_manage') }}
            </div>
          </template>
